...
<section class="content">
    <div class="bg-image-vertical " style="background-color: #EFD3E4;
                    ...
                    <div class="col-12 col-lg-10 m-4">
                        <div class=" bg-white" style="border-radius: 1rem;">
                            <div class="p-3">
                                ...
                                <form action="/user/update-process" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-outline mb-2">
                                        ...
                                        <input type="file" class="form-control-file" id="image" name="profileImage">
                                    </div>

                                    <div class="form-check d-flex justify-content-center mb-2">
                                        <label class="form-check-label" for="form6Example8"> Enable Account </label>
                                        <input
                                    ...
                                    <button type="submit" class="btn btn-secondary btn-rounded btn-block">Save Profile
                                    </button>
                                </form>
